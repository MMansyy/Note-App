            ...
            <div className='self-start my-6'>
                <form className=" mx-auto">
                    ...
                    <div className="relative">
                        ...
                        }} type="search" id="default-search" className="block w-full p-2.5 ps-10 px-40 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-black focus:border-black dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-black dark:focus:border-black" placeholder="Search by title" required />
                    </div>
                </form>
            </div>
